...
class CreateSites < ActiveRecord::Migration
  def self.up
    ...
    execute "INSERT INTO sites (name, title, path, host, gender, email, twitter, facebook, blog) VALUES
        ('Projeto O. S.', 'Projeto Open Source', 'projetoopensource', 'localhost', 'male', 'contato@localhost', 'POSTwitter', 'http://www.facebook.com/POSFace', 'http://blog.localhost'), ('Catarse', 'A primeira plataforma de financiamento colaborativo de projetos criativos do Brasil', 'catarse', 'catarse.me', 'male', 'contato@catarse.me', 'Catarse_', 'http://www.facebook.com/Catarse.me', 'http://blog.catarse.me'),
